...
{
    [SerializeField]    private EditablePrimitive currentSelection;
    [SerializeField]    private ScaleObjectController scaleObjectController;
    ...
    [SerializeField]    private Material objectValidMaterial;
    [SerializeField]    private Material objectInvalidMaterial;
    [SerializeField]    private Material objectSelectedMaterial;
    [SerializeField]    private Material objectFresnelSelectedMaterial;
    [SerializeField]    private Material objectFresnelInvalidMaterial;
    ...
    void Update() {
        Cursor.lockState = Input.GetKey(KeyCode.LeftAlt) || isDraggingOutObject ? CursorLockMode.None :
        ...
        //Custom logic for when an item is being dragged out to instantiate it
    ...
    void SelectObject(EditablePrimitive obj) {
        ...
        colorPicker.SetColor(currentSelection.color);
    }
    ...
    public void PasteClipboard() {
        if (!clipboardObject)
            return;
        if (currentSelection && !currentSelection.IsValid)
            return;
